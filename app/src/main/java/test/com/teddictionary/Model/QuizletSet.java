...
public class QuizletSet {
    /**
     * id : 249949856
     * url : /249949856/tue-5-dec-2017-flash-cards/
     * title : Tue 5 Dec 2017
     * created_by : yuhsiung_lin
     * term_count : 2
     * created_date : 1512447008
     * modified_date : 1512447245
     * published_date : 1512447244
     * has_images : false
     * subjects : []
     * visibility : public
     * editable : only_me
     ...
     * class_ids : []
     * terms : [{"id":8252390762,"term":"prune","definition":"(ver.): to cut off some of the branches of (a tree or bush) so that it will grow better or look better\n\n-She carefully pruned the hedge.\n\n-Those trees need to be pruned every year.","image":null,"rank":0},{"id":8252400962,"term":"cut off","definition":"to remove something from something larger by cutting\n\n-He had his finger cut off in an accident at work.\n\n-The winner cut ten seconds off (= ran the distance ten seconds faster than) the world record.","image":null,"rank":1}]
     * display_timestamp : 上週
     */
    ...
    public static class TermsBean {
         ...
         * id : 8252390762
         * term : prune
         * definition : (ver.): to cut off some of the branches of (a tree or bush) so that it will grow better or look better
